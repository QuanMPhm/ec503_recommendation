...
class DataGenerator():
    ...
    def save_variables(self):
        file_name = 'DG_data_news/users'
        self.save_variable(variable=self.users, filename=file_name)
        file_name = 'DG_data_news/items'
        self.save_variable(variable=self.items, filename=file_name)
        file_name = 'DG_data_news/histo'
        self.save_variable(variable=self.histo, filename=file_name)
